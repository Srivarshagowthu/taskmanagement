package com.varsha.process.dto;
...
@Id
  ...
  /**
   * Default constructor
   * @deprecated Use {@link Process#Process(String, String, String)}
   */
  @Deprecated
  public Process() {
    super();
   ...
   */
  public Process(String name, String description, String title) {
    this.name = name;
    this.description = description;
    this.title = title;
  }

  public Process id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  */
  @NotNull 
  @Schema(name = "name", example = "Sample Process", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("name")
  ...
  */
  @NotNull 
  @Schema(name = "description", example = "This is a sample process description.", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  */
  @NotNull 
  @Schema(name = "title", example = "Sample Process Title", requiredMode = Schema.RequiredMode.REQUIRED)
  @JsonProperty("title")
