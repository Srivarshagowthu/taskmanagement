...
public class ProcessInstanceApiDelegateImpl implements ProcessinstanceApiDelegate {
  ...
  @Override
  public ResponseEntity<List<ProcessInstanceDTO>> createProcess(
      CreateProcessRequest createProcessRequest) throws Exception {
    List<ProcessInstanceDTO> createdProcesses =
        processInstanceService.createProcess(createProcessRequest);
  ...
  public ResponseEntity<List<ProcessInstanceTaskDTO>> getProcessInstanceDetails(
    ...
    try {
      List<ProcessInstanceTaskDTO> taskDetails =
          (List<ProcessInstanceTaskDTO>)
              processInstanceService.getProcessInstanceDetails(processInstanceId);
  ...
  public ResponseEntity<List<ProcessInstanceStatus>> getProcessInstanceStatuses() {
    try {
      List<ProcessInstanceStatus> statuses =
          (List<ProcessInstanceStatus>) processInstanceService.getProcessInstanceStatuses();
